...
public class DeliverableTest {
    ...
    public void testGetCostEstimate() {
        Assert.assertEquals("Deliverable.getCostEstimate() should return the correct value!", 61,
                deliverable.getCostEstimate(), 0.0001);
    }

    @Test
    public void testGetMaterialCost() {
        Assert.assertEquals("Deliverable.getMaterialCost() should return the correct value!", 55,
                deliverable.getMaterialCost());
    }

    @Test
    public void testGetTimeRequired() {
        Assert.assertEquals("Deliverable.getTimeRequired() should return the correct value!", 2.5,
                deliverable.getTimeRequired(), 0.0001);
    }

    @Test
    public void testGetDate() {
        Assert.assertEquals("Deliverable.getDate() should return the correct object!", date, deliverable.getDate());
    }
}
