...
public class TaskTest {
    ...
    public void testEmptyTask() {
        ...
        Assert.assertEquals("Task.getMaterialCost() should return 0 if no ProjectItem has been added!", 0,
                emptyTask.getMaterialCost());
        Assert.assertEquals("Task.getTimeRequired() should return 0 if no ProjectItem has been added!", 0,
    ...
    public void testGetMaterialCost() {
        Assert.assertEquals("Task.getMaterialCost() should return the costs of all Deliverables!", 2400, t1.getMaterialCost());
        Assert.assertEquals("Task.getMaterialCost() should return the costs of all Deliverables!", 403, t2.getMaterialCost());
        Assert.assertEquals("Task.getMaterialCost() should return the costs of all Deliverables and subtasks!", 2404,
                t3.getMaterialCost());
        Assert.assertEquals("Task.getMaterialCost() should return the correct value!", 7206, mainTask.getMaterialCost());
    }

    @Test
    public void testGetTimeRequired() {
        Assert.assertEquals("Task.getTimeRequired() should return the time of all Deliverables!", 3.33, t1.getTimeRequired(),
                0);
        Assert.assertEquals("Task.getTimeRequired() should return the time of all Deliverables!", 6.5, t2.getTimeRequired(),
                0.0001);
        Assert.assertEquals("Task.getTimeRequired() should return the time of all Deliverables and subtasks!", 14.33,
                t3.getTimeRequired(), 0.0001);
        Assert.assertEquals("Task.getTimeRequired() should return the correct value!", 26.49, mainTask.getTimeRequired(),
                0.0001);
    }
